...
<head>
    ...
    <style>
        ...
        .producto { border: 1px solid #ddd; padding: 15px; margin-bottom: 12px; border-radius: 8px; }
        .sin-stock { color: red; font-weight: bold; }
        .con-stock { color: green; font-weight: bold; }
    </style>
</head>
<body>
    ...
    <footer>
        <p>Trabajo práctico de Laravel - Vistas Blade</p>
    </footer>
